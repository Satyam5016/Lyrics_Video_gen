...
def generate_lyric_video(audio_file, lyrics_file, output_file):
    ...
    for i, line in enumerate(lyrics):
        ...
        text_clip = TextClip(line.strip(), fontsize=70, color='white', size=(1280, 720), method='label')
        text_clip = text_clip.set_duration((end_time - start_time) / 1000).set_position('center')
...
def generate():
    ...
    generate_lyric_video(audio_path, lyrics_path, output_path)
